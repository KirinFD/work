...
// It provides access to the samples it recorded during the _previous_ complete second.
// 
// The application will do a number of actions each second which
// must be synchronized (such as computing dips and printing to the 
// screen). To make easy to work with data, the app must call
...
// Get the number of samples collected during the previous complete
// second.
int Sampler_getHistorySize(void);

// Get a copy of the samples in the sample history.
// Returns a newly allocated array and sets 'size' to be the number
// of elements in the returned array (output-only parameter).
...
void Sampler_sampleBuffer(void);
